...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('CASH_ON_DELIVERY', 'STRIPE', 'PAYPAL', 'CUSTOM');

-- CreateEnum
CREATE TYPE "AiProvider" AS ENUM ('OPENAI', 'ANTHROPIC', 'GEMINI', 'OPENROUTER', 'CUSTOM');
...
CREATE TABLE "SiteSettings" (
    "id" TEXT NOT NULL,
    "shopName" TEXT NOT NULL DEFAULT 'MyShop',
    "logoUrl" TEXT,
    "faviconUrl" TEXT,
